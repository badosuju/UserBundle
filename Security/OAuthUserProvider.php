...
class OAuthUserProvider implements OAuthAwareUserProviderInterface, UserProviderInterface {
     ...
     */
    public function __construct( UserManager $userManager, TokenStorage $tokenStorage, $args = [ ], Session $session, $validator ) {
    ...
    public function loadUserByOAuthUserResponse( UserResponseInterface $response ) {
        ...
        /** @var User $user */
        $user = $this->userManager->loadUser( array( 'facebookId' => $socialID ) );
        $update = true;
